(function () {
  ...
  lb.querySelector('.lb-onceki').onclick = function () { lbGoster((lbIndex - 1 + TUM_FOTOLAR.length) % TUM_FOTOLAR.length); };
  lb.querySelector('.lb-sonraki').onclick = function () { lbGoster((lbIndex + 1) % TUM_FOTOLAR.length); };
